...
public class SideSqlExecTest {
    ...
    @Test
    public void testCepSql1() throws Exception {
        ...
        String sqlContext = "CREATE table source(" +
                ...
                "name varchar )" +
                "with (" +
                " type = 'kafka09',kafka.bootstrap.servers = '127.0.0.1:9092', kafka.auto.offset.reset = 'latest',kafka.topic = 'kafkatopictest',parallelism = '1' " +
                ");"
                + "CREATE table sink(" +
                "aid int, " +
                "bid int, " +
                "cid int ) " +
                "with (" +
                " type = 'mysql',url = 'jdbc:mysql://127.0.0.1:3306/flink?charset=utf8&useSSL=true',userName = 'root',password = '1234',tableName = 'MyCep',parallelism = '1' " +
                ");"
                + "insert into sink " +
    ...
    public void testCepSql() throws Exception {
        ...
        String sqlContext = "CREATE table source(" +
                ...
                "tstamp timestamp) " +
                "with (" +
                " type = 'kafka09',bootstrapServers = '127.0.0.1:9092',zookeeperQuorum = '127.0.0.1:2181', offsetReset = 'latest',topic = 'kafkatopictest',parallelism = '1' " +
                ");"
                + "CREATE table sink(" +
...
//        sql = URLDecoder.decode(sql, org.apache.commons.io.Charsets.UTF_8.name());
    ...
    public void test2(String sql) throws Exception {
        ...
        paramList.add("xc");
        paramList.add("-localSqlPluginPath");
        paramList.add("/Users/lcg/workspace_58/flinkStreamSQL/plugins");
        paramList.add("-mode");
        paramList.add("local");
        paramList.add("-confProp");
